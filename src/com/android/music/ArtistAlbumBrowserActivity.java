...
import com.android.music.utils.QueueHelper;
...
public class ArtistAlbumBrowserActivity extends ExpandableListActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (mAdapter == null) {
            ...
            mAdapter = new ArtistAlbumListAdapter(this,
                    new ArrayList<ConcurrentHashMap<String, MediaBrowser.MediaItem>>(),
                    R.layout.track_list_item_group, new String[] {}, new int[] {},
                    new ArrayList<ArrayList<ConcurrentHashMap<String, MediaBrowser.MediaItem>>>(),
        ...
        public void onChildrenLoaded(String parentId, List<MediaBrowser.MediaItem> children) {
            if (parentId.equals(MediaIDHelper.MEDIA_ID_MUSICS_BY_ARTIST)) {
                ...
                for (MediaBrowser.MediaItem item : children) {
                    ...
                    mMediaBrowser.subscribe(item.getMediaId(), mSubscriptionCallback);
                }
    ...
    private class ArtistAlbumListAdapter extends SimpleExpandableListAdapter {
        ...
        private ArrayList<ArrayList<ConcurrentHashMap<String, MediaBrowser.MediaItem>>> mChildData;
        ...
        ArtistAlbumListAdapter(ArtistAlbumBrowserActivity currentactivity,
                ...
                ArrayList<ArrayList<ConcurrentHashMap<String, MediaBrowser.MediaItem>>> childData,
                int childLayout, String[] childFrom, int[] childTo) {
            super(currentactivity, groupData, groupLayout, groupFrom, groupTo, childData,
        ...
        public ArrayList<ArrayList<ConcurrentHashMap<String, MediaBrowser.MediaItem>>>
        getChildData() {
            return mChildData;
        }
